  ...
  return (
    <div className="space-y-8 max-w-2xl mx-auto">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h2 className="text-3xl font-bold text-slate-800 dark:text-white">Edit Mata Kuliah</h2>
          <p className="text-slate-500 dark:text-slate-400">Perbarui informasi mata kuliah Anda.</p>
        </div>
      </div>
      ...
      >
        ...
        >
          {loading ? "Memperbarui..." : "Update Mata Kuliah"}
        </button>
      </motion.form>
    </div>
  );
